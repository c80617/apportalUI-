...
import brahma.vmi.covid2019.auth.BrahmaKeyManager;
...
public class SSLConfig implements Constants {
    ...
    public SSLSocketFactory getSocketFactory() {
        ...
        try {
            factory = new BrahmaSSLSocketFactory(sslContext, ENABLED_CIPHERS, ENABLED_PROTOCOLS);
        } catch (NoSuchAlgorithmException e) {
    ...
    private void doConfigure() throws KeyStoreException, CertificateException,
        ...
        // if certificate authentication is enabled, use a key manager with the provided alias
            keyManagers = new KeyManager[]{new BrahmaKeyManager(context, connectionInfo.getCertificateAlias())};
