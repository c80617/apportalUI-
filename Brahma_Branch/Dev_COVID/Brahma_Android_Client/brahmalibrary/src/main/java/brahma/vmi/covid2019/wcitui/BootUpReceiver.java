...
//            mNotificationManager.notify(1, builder.build());
            ...
            Notification notification
                    ...
                    .setSmallIcon(R.drawable.brahma_app_icon) // 設置狀態列裡面的圖示（小圖示）　　
                    .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.brahma_app_icon)) // 下拉下拉清單裡面的圖示（大圖示）
