...
public class BiometricPromptApi28 implements IBiometricPromptImpl {
    ...
    public BiometricPromptApi28(Activity activity) {
        mActivity = activity;
        ItemBio itemBio = new ItemBio(context);

        mBiometricPrompt = new BiometricPrompt
                .Builder(activity)
                .setTitle(context.getResources().getString(R.string.verficiation))
                .setDescription(context.getResources().getString(R.string.verficiation_message)+itemBio.get(1).getbioUsername())
                .setSubtitle("")
