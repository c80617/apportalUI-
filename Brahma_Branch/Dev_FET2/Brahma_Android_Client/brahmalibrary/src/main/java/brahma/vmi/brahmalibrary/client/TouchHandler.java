...
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.Request.RequestType;
...
//    private PerformanceAdapter spi;
    ...
    public TouchHandler(CallActivity activity, Point displaySize) {
        ...
        for (int i = 0; i < pointerCount; i++) {
            ...
            switch (vmRotation) {
                ...
                case 1:
                    ...
                    adjY = event.getY(i);
                    Log.i(TAG, "Scale factor: " + xScaleFactor + " ; " + yScaleFactor);
                    Log.i(TAG, "original: vmX: " + vmX + " ; vmY:" + vmY);
                    Log.i(TAG, "original: adjX: " + adjX + " ; adjY:" + adjY);
//                            float newY = adjY - vmX;
...
//        BRAHMAProtocol.TouchEvent.HistoricalEvent.Builder h = BRAHMAProtocol.TouchEvent.HistoricalEvent.newBuilder();
        ...
        eventmsg.setAction(1);
        eventmsg.setDownTime(downTime);
        eventmsg.setEventTime(eventTime);
        eventmsg.setEdgeFlags(0);
