...
import brahma.vmi.brahmalibrary.client.IntentHandler;
import brahma.vmi.brahmalibrary.client.LocationHandler;
import brahma.vmi.brahmalibrary.client.SensorHandler;
...
import brahma.vmi.brahmalibrary.common.FileHandler;
...
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.AuthResponse.AuthResponseType;
...
//        timer.schedule(timerTask,0,5000);//周期为1秒
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.d("LifeCycle", "getState() "+getState());
...
//            startup(1);
    ...
    private void startup(int connectionID) {
        ...
        if (databaseHandler.getConnectionInfo(connectionID) != null) {
