...
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.LocationProviderEnabled;
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.LocationProviderInfo;
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.LocationProviderStatus;
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.LocationRequest;
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.LocationUpdate;
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.Request;
import brahma.vmi.brahmalibrary.protocol.BRAHMAProtocol.RotationInfo;

import static brahma.vmi.brahmalibrary.wcitui.BrahmaMainActivity.DPI;
...
//        Drawable badge;
//        if (Constants.API_15)
//            badge = getDrawable15(context, R.drawable.brahma_icon_overlay, screenDensity);
//        else
//            badge = getDrawable(context, R.drawable.brahma_icon_overlay);
...
//        launchIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK); // when this is started, clear other Brahma activities
...
//    }
    ...
    public static Request toRequest_LocationProviderInfo() {/////////////////////////////////////////////////////////
        // create a LocationProviderInfo Builder
        LocationProviderInfo.Builder lpiBuilder = LocationProviderInfo.newBuilder()
                // set required variables
                .setProvider("gps")
                .setRequiresNetwork(true)
                .setRequiresSatellite(true)
                .setRequiresCell(false)
    ...
    public static Request toRequest_LocationUpdate() {
        LocationUpdate.Builder luBuilder = LocationUpdate.newBuilder()
    ...
    public static Request toRequest_RotationInfo(int rotation) {
        ...
        BRAHMAProtocol.ScreenInfoClient.Builder riBuilder2 = BRAHMAProtocol.ScreenInfoClient.newBuilder()
                .setScreenX(widthPixels)
                .setScreenY(heightPixels)
                .setScreenDPI(DPI);

        Request.Builder rBuilder = Request.newBuilder()
                .setType(Request.RequestType.ROTATION_INFO)
                .setRotationInfo(riBuilder)
                .setScreenInfoClient(riBuilder2);
