...
package brahma.vmi.brahmalibrary.autobahn;
...
import brahma.vmi.brahmalibrary.autobahn.WebSocket.WebSocketConnectionObserver.WebSocketCloseNotification;
import brahma.vmi.brahmalibrary.autobahn.WebSocketMessage.WebSocketCloseCode;
...
public class WebSocketConnection implements WebSocket {
	...
	public void disconnect() {
		if (mWebSocketWriter != null && mWebSocketWriter.isAlive()) {
			...
			Log.d(TAG, "mWebSocketWriter disconnect");
		} else {
...
//			Log.d(TAG, "WebSockets Pong received" + pong.mPayload);
	...
	public static class SocketThread extends Thread {
        ...
        private final WebSocketOptions mOptions; // addition
		...
		public SocketThread(URI uri, WebSocketOptions options) {
            ...
            this.mOptions = options; // addition
		}
