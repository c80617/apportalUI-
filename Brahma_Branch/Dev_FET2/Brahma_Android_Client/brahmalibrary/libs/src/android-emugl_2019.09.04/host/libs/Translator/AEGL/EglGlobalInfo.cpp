...
EglGlobalInfo::EglGlobalInfo() {
    if (isEgl2Egl()) {
        INFO("AEGL EglGlobalInfo: Using Egl2Egl as engine...");
#if (defined(ANDROID) || defined(__ANDROID__))
        // for easier maintainence, lets use an separate file Android platform
        // host/libs/Translator/AEGL/EglOsApi_android.cpp
...
// Android defines both EGLNativeDisplayType and EGLDisplay as void *
