    ...
    public Bitmap getBitmap() {
        ...
        if (icon != null && icon.length > 0) {
            try {
                ...
                Log.e(TAG, String.format("Failed decoding icon for app: " +"[connectionID '%d', packageName '%s', appName '%s']",connectionID, packageName, appName));
                AndroidLogger.e(TAG, String.format("Failed decoding icon for app: " +"[connectionID '%d', packageName '%s', appName '%s']",connectionID, packageName, appName));
            }
        }
